...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{fig/img/frame_front.jpg}
    \end{minipage}\hfill
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{fig/img/frame_side.jpg}
    \end{minipage}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{fig/img/full_test_setup.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{fig/img/pv_panel.jpg}
...
Podczas pomiarów na zewnątrz budynku, podobnie jak w~przypadku pomiarów wewnętrznych, nie 
